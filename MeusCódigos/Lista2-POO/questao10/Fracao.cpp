...
{
	Fracao ret;
	ret.setNumerador(i * numerador);
	ret.setDenominador(denominador);
	return ret;
}
...
{
	Fracao ret;
	ret.setNumerador(numerador);
	ret.setDenominador(i * denominador);
	return ret;
}
...
Fracao Fracao::operator+ (int i)
{
	Fracao ret;
	ret.setDenominador(denominador);
	ret.setNumerador(numerador + (denominador * i));
	return ret;
}
